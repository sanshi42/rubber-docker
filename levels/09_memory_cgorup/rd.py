#!/usr/bin/env python3
"""从零实现 Docker 工作坊 - Level 9：添加 Memory Control group。

目标：防止你的 container 吃光所有 RAM。
"""
...
def contain(command, image_name, image_dir, container_id, container_dir,
    ...
    # TODO: 类似 CPU cgorup，在这里添加 Memory cgroup 支持
    #       如果它们不是 None，就设置 memory -> memory.limit_in_bytes，
    #       memory_swap -> memory.memsw.limit_in_bytes
